...
<head>
    ...
    <style>
        /* Background Image */
        body {
            background: url('https://wallpaperaccess.com/full/650768.jpg') no-repeat center center fixed;
                                ...
                                <form action="/login" method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email"
                                            placeholder="Enter email"  value="{{$_SESSION['data']['email'] ?? null}}">
                                    </div>
                                    <div class="mb-3">
                                ...
                                <form action="/register" method="POST" enctype="multipart/form-data" >
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" id="name"
                                            placeholder="Enter full name"  value="{{$_SESSION['data']['name'] ?? null}}">
                                    </div>
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Email address</label>
                                        <input type="email" class="form-control" name="email" id="email"
