                    ...
                    <div class="container">
                        <form action="/admin/products/store" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    <textarea name="overview" id="overview" class="form-control">{{$_SESSION['data']['overview'] ?? null}}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="content" class="col-4 col-form-label">Content</label>
                                <div class="col-8">
                                    <textarea name="content" id="content" class="form-control">{!! $_SESSION['data']['content'] ?? null !!}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row align-items-center">
                                ...
                                <div class="col-8">
                                    <input type="checkbox" class="form-check-input" value="1" name="is_sale" id="is_sale" />
                                </div>
                            </div>
                            <div class="mb-3 row align-items-center">
                                <label for="is_show_home" class="col-4 col-form-label">Is Show Home?</label>
                                <div class="col-8">
                                    <input type="checkbox" class="form-check-input" value="1" name="is_show_home" id="is_show_home" />
                                </div>
                            </div>
