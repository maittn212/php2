                        ...
                        <tbody>
                                @foreach ($data as $product)
                                     <tr>
                                        ...
                                        <td>
                                            @if (isset($product['p_price_sale']) && $product['p_price_sale'] !== null)
                                                {{number_format($product['p_price_sale'])}}
                                            @else
                                        ...
                                        <td>
                                            <a href="/admin/products/show/{{$product['p_id']}}" class="btn btn-sm btn-info">Show</a>
                                            <a href="/admin/products/edit/{{$product['p_id']}}" class="btn btn-sm btn-warning">Edit</a>
                                            <a href="/admin/products/delete/{{$product['p_id']}}" class="btn btn-sm btn-danger" onclick="return confirm('Có chắc chắn xóa không?')">Delete</a>
                                        </td>
                                     </tr>
