                    ...
                    <div class="container">
                        <form action="/admin/products/update/{{$product['p_id']}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-8">
                                   <select name="category_id" id="category_id">
                                        ...
                                        @foreach ($categories as $category)
                                            <option @selected($category['id'] == $product['p_category_id']) value="{{$category['id']}}">{{$category['name']}}</option>
                                        @endforeach
                                   </select>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    <textarea name="overview" id="overview" class="form-control">{{$product['p_overview'] ?? null}}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="content" class="col-4 col-form-label">Content</label>
                                <div class="col-8">
                                    <textarea name="content" id="content" class="form-control">{!! $product['p_content'] ?? null !!}</textarea>
                                </div>
                            </div>
                            <div class="mb-3 row">
                                <label for="img_thumnail" class="col-4 col-form-label">Img thumbnail</label>
                                <div class="col-8">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-8">
                                    <input type="number" class="form-control" name="price_sale" id="price_sale"
                                        value="{{$product['p_price'] ?? 0}}" />
                                </div>
                            </div>
                            <div class="mb-3 row align-items-center">
                                <label for="is_active" class="col-4 col-form-label">Is Active?</label>
                                <div class="col-8">
                                    <input type="checkbox" class="form-check-input" @checked($product['p_is_active'])  value="1" name="is_active" id="is_active" />
                                </div>
                            </div>
                            <div class="mb-3 row align-items-center">
                                <label for="is_sale" class="col-4 col-form-label">Is Sale?</label>
                                <div class="col-8">
                                    <input type="checkbox" @checked($product['p_is_sale']) class="form-check-input" value="1" name="is_sale" id="is_sale" />
                                </div>
                            </div>
                            <div class="mb-3 row align-items-center">
                                <label for="is_show_home" class="col-4 col-form-label">Is Show Home?</label>
                                <div class="col-8">
                                    <input type="checkbox" class="form-check-input" @checked($product['p_is_show_home'])  value="1" name="is_show_home" id="is_show_home" />
                                </div>
                            </div>
