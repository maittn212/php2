...
class ProductController extends Controller
{
    ...
    public function update($id)
    {
        ...
        try {
            ...
            // điều chỉnh dl
            // Nếu price_sale là chuỗi rỗng thì gán giá trị = null, ngược lại giữ nguyênnguyên
            $data['price_sale'] = $data['price_sale'] === '' ? null : $data['price_sale'];
            ...
            $data['updated_at'] = date("Y-m_d H:i:s");

            // var_dump(file_exists($product['p_img_thumbnail']), $product['p_img_thumbnail']);die();

            // update
            $this->product->update($id, $data);

            // Xóa ảnh cũ
            if ($data['img_thumbnail'] != $product['p_img_thumbnail'] && $product['p_img_thumbnail'] && file_exists($product['p_img_thumbnail'])) {
